    ...
    public partial class BangazonTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "00000000-ffff-ffff-ffff-ffffffffffff", 0, "38427d04-995f-485f-a213-2909187faedd", "admin@admin.com", true, "Admina", "Straytor", false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAELPm6blHG7ZIP4hp+LWslfLN7SOX3AOdiTR57Ibpm5HVsdyqWl4zcO/hKgcKPkI0JQ==", null, false, "7f434309-a4d9-48e9-9ebb-8803db794577", "123 Infinity Way", false, "admin@admin.com" });
            ...
            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "OrderId", "DateCompleted", "PaymentTypeId", "UserId" },
                values: new object[] { 2, null, null, "00000000-ffff-ffff-ffff-ffffffffffff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, null, "It flies high", null, 2.99m, 1, 100, "Kite", "00000000-ffff-ffff-ffff-ffffffffffff" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "Active", "City", "Description", "ImagePath", "Price", "ProductTypeId", "Quantity", "Title", "UserId" },
                values: new object[] { 2, true, null, "It rolls fast", null, 29.99m, 2, 5, "Wheelbarrow", "00000000-ffff-ffff-ffff-ffffffffffff" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "Active", "City", "Description", "ImagePath", "Price", "ProductTypeId", "Quantity", "Title", "UserId" },
                values: new object[] { 3, true, null, "It cuts things", null, 31.49m, 3, 18, "Saw", "00000000-ffff-ffff-ffff-ffffffffffff" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "Active", "City", "Description", "ImagePath", "Price", "ProductTypeId", "Quantity", "Title", "UserId" },
                values: new object[] { 4, true, null, "It puts holes in things", null, 24.89m, 3, 12, "Electric Drill", "00000000-ffff-ffff-ffff-ffffffffffff" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ProductId", "Active", "City", "Description", "ImagePath", "Price", "ProductTypeId", "Quantity", "Title", "UserId" },
                values: new object[] { 5, true, null, "It puts things together", null, 22.69m, 3, 32, "Hammer", "00000000-ffff-ffff-ffff-ffffffffffff" });
